...
export default function PageContainer({
  ...
  return (
    <div className="flex min-h-full flex-1 flex-col items-center">
      ...
      {topNavbar && (
        <nav className="bg-content2/70 fixed top-0 right-0 left-0 z-50 backdrop-blur-lg">
          <div className="from-content2 flex w-full justify-center bg-linear-to-b to-transparent px-2">
            <div className="w-full max-w-5xl">{topNavbar}</div>
          </div>
        </nav>
      )}

      <main className="flex w-full flex-1 justify-center overflow-x-hidden overscroll-x-none px-2 py-4">
      ...
      {bottomNavbar && (
        <nav className="bg-content2/70 fixed right-0 bottom-0 left-0 z-50 w-full rounded-t-xl backdrop-blur-lg">
