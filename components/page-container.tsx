...
export default function PageContainer({
  ...
  return (
    <div className="flex min-h-full flex-1 flex-col justify-center">
      ...
      {topNavbar && (
        <nav className="fixed top-0 z-50 w-full bg-content2/70 backdrop-blur-lg">
      ...
      {bottomNavbar && (
        <nav className="fixed bottom-0 z-50 w-full rounded-t-xl bg-content2/70 backdrop-blur-lg">
